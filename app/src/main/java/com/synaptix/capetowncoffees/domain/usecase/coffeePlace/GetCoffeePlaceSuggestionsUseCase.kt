...
class GetCoffeePlaceSuggestionsUseCase @Inject constructor(
    ...
    suspend operator fun invoke(params: CoffeeSearchParameters, userLatLng: LatLng): Result<List<CoffeePlaceSuggestion>> {
        return coffeePlaceRepository.getSuggestions(params, userLatLng)
    }
}
